...
<body>
    ...
    <nav class="navbar py-2 navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">Aqua BANK <img src="logos/logo.webp" alt="Bank" width="50" height="50"></a>
    ...
    <class class="welcome">
        <h2>
            <strong>Lets build a Better Payment Gateway with Aqua Bank!!</strong> </h2>
    </class>
